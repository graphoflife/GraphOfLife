...
while True:
    ...
    parent_dir = r"D:\NewGraphCompetition Outputs\Outputs6"
    ...
    for i in range(iterations_per_competition):
        ...
        while ALL_TOKEN_AMOUNT > TOKEN_PER_SIMULATION:
            ...
            simulation_options.load(r"Guessed1 Probabilistic can move to walker.csv",r"D:\NewGraphCompetition Outputs\Favorite")
        ...
        for cur_sim in all_simulations:
            if sum([cur_par.token for cur_par in cur_sim.particles]) > 0.1*ALL_TOKEN_AMOUNT_INIT:
                cur_sim.run_options_dict[RunOptionsEnum.SMOOTH_PLOTS] = 6
